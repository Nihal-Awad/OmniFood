...
<head>
    ...
    <link rel="stylesheet" href="vendors/css/ionicons/">
  ...
  />
   <link rel="apple-touch-icon" sizes="180x180" href="styles/favicon/apple-touch-icon.png">
    ...
    <link rel="mask-icon" href="styles/favicon/safari-pinned-tab.svg" color="#000000">
...
<body>
    <header>
        <nav>
            <div class="row">
                <img src="assets/logo-white.png" alt="Omnifood logo" class="logo">
                <img src="assets/logo.png" alt="Omnifood logo" class="logo-black">
    ...
    <section class="section-feature js--section-feature" id="features">
        <div class="row">
    ...
    <section class="section-steps" id="works">
        ...
        <div class="row">
            <div class="col span-1-of-2 steps-box">
                <img src="assets/app-iPhone.png" alt="Omnifood app on iPhone" class="app-screen js--wp-2">
            </div>
            <div class="col span-1-of-2 steps-box">
                ...
                <a href="#" class="btn-app"><img src="assets/download-app.svg" alt="App Store Button"></a>
                <a href="#" class="btn-app"><img src="assets/download-app-android.png" alt="Play Store Button"></a>
            </div>
        </div>
    </section>
        ...
        <div class="row">
            <div class="col span-1-of-3">
                <blockquote>Omnifood is just awesome! I just launched a startup which leaves me with no time for cooking, so Omnifood is a life-saver. Now that I got used to it, I couldn't live without my daily meals!
                    <cite><img src="assets/customer-1.jpg" alt="Alberto Duncan">Alberto Duncan</cite>
                </blockquote>
            </div>
            <div class="col span-1-of-3">
                <blockquote>Inexpensive, healthy and great-tasting meals, delivered right to my home. We have lots of food delivery here in Lisbon, but no one comes even close to Omifood. Me and my family are so in love!
                    <cite><img src="assets/customer-2.jpg" alt="Joana Silva">Joana Silva</cite>
                </blockquote>
            </div>
            <div class="col span-1-of-3">
                <blockquote>I was looking for a quick and easy food delivery service in San Franciso. I tried a lot of them and ended up with Omnifood. Best food delivery service in the Bay Area. Keep up the great work!
                    <cite><img src="assets/customer-3.jpg" alt="Milton Chapman">Milton Chapman</cite>
                </blockquote>
            </div>
        ...
        <div class="row">
            <div class="col span-1-of-3">
                <div class="plan-box js--wp-4">
                    ...
                    <div>
                        <ul>
                            <li><ion-icon name="checkmark"
                                class="icon-small" ></ion-icon>1 meal every day</li>
                ...
                <div class="plan-box">
                    ...
                    <div>
                        <ul>
                            ...
                            <li><ion-icon name="close-outline"
                                class="icon-small"></ion-icon></li>
        ...
        <div class="row">
            ...
            <div class="col span-1-of-2">
                <ul class="social-links clearfix" >
                    ...
                    <li><a href="#"><ion-icon name="logo-whatsapp" class="logo-whatsapp"></ion-icon></a></li>
                    
                </ul>
            </div>
        </div>
        <div class="row">
            <p>Copyright &copy; 2021 by Omnifood. All rights reserved. Developed by Nihal Awadh.</p>
        </div>
    </footer>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-ZKTX21LGTH"></script>
    <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'G-ZKTX21LGTH');
    </script>
</body>
</html>
